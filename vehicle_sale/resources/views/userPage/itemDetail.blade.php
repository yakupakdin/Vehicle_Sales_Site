...
@php
$item=\App\Models\Products::where("id",$itemCar['id'])->first();
$model=\App\Models\ProductsModel::where("id",$item['model'])->first();
$marka = \App\Models\ProductsModelBrand::where("id",$model['marka'])->first();
@endphp
...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner border">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="{{asset($itemCar['resimUrl'])}}" alt="Image">
                    </div>
        ...
        <div class="col-lg-7 pb-5">
            <h3 class="font-weight-semi-bold">{{$itemCar['ad']}}</h3>
            ...
            <h3 class="font-weight-semi-bold mb-4">{{$itemCar['fiyat']}} ₺</h3>

            <div class="d-flex mb-3">
                <p class="text-dark font-weight-medium mb-0 mr-3">Marka: {{$marka['isim']}}</p>

            </div>
            <div class="d-flex mb-4">
                <p class="text-dark font-weight-medium mb-0 mr-3">Model: {{$model['isim']}}</p>
