...
@if($errors->any())
    <div class="alert" role="alert" style="text-align: center;">
        <span class="text-sm" style="font-size: 0.875rem !important; color: red;border: 1px solid gray;padding:25px;border-radius: 10px;"><i class="fas fa-exclamation-circle"></i>&nbsp;&nbsp;{{$errors->first()}}</span>
    </div>
@endif
</div>
...
{{--                        </div>--}}
                        ...
                        <button type="submit" name="siparisver" class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">Sipariş Ver</button>
                        </form>
                    </div>
                </div>
            </div>
